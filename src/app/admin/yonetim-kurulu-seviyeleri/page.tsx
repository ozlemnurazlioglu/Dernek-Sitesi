...
import type { BoardLevelConfig } from "@/lib/types";
...
export default function YonetimKuruluSeviyeleriPage() {
  return (
    <ContentListAdmin
      type="board-levels"
      title="Yönetim Kurulu Seviyeleri"
      description="Hiyerarşi seviyelerini (Başkan, Yönetim, Üye, vb.) buradan yönetin. Her seviyenin avatar boyutu ve sıralaması ayrı düzenlenir. Yeni seviye ekleyip üyeleri o seviyeye atayabilirsiniz."
      singular="Seviye"
      fields={[
        {
          key: "slug",
      ...
      renderRow={(item) => {
        const lv = item as unknown as BoardLevelConfig;
